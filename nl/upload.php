...
$lang = array_merge($lang, array(
	...
	'EXTENSION_UPLOAD_EXPLAIN'			=> 'Hier kun je een zip bestand uploaden dat de vereiste bestanden bevat om een extensie te installeren vanaf een lokale computer of een andere server. “Upload Extensions” zal het zip bestand uitpakken en klaarmaken voor installatie.<br />Kies een bestand of typ een link hier beneden.',
	'EXT_UPLOAD_INIT_FAIL'				=> 'Er is een fout opgetreden bij het voorbereiden op de installatie.',
	'EXT_NOT_WRITABLE'					=> 'De ext/ map is niet schrijfbaar. Dit is vereist om “Upload extension” goed te laten functioneren. Verander de permissies en probeer het opnieuw.',
