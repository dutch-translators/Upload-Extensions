...
$lang = array_merge($lang, array(
	...
	'ACP_UPLOAD_EXT_TITLE_EXPLAIN'		=> 'Upload Extensies maakt het mogelijk om zip bestanden van extensies te uploaden of extensies te verwijderen.<br />Met deze extensie kan je extensies installeren/updaten/verwijderen zonder FTP te gebruiken. Als de geüploade extensie al bestaat, wordt de huidige extensie geüpdatet.',
	'UPLOAD'							=> 'Uploaden',
	'BROWSE'							=> 'Bladeren...',
	'EXTENSION_UPLOAD'					=> 'Upload extensie',
	'EXTENSION_UPLOAD_EXPLAIN'			=> 'Hier kan je een zip bestand uploaden, dat de vereiste bestanden bevat om een extensie te installeren, vanaf een lokale computer of een andere server. “Upload Extensies” zal het zip bestand uitpakken en klaarmaken voor installatie.<br />Kies een bestand of vul een link hier beneden in.',
	'EXT_UPLOAD_INIT_FAIL'				=> 'Er is een fout opgetreden bij het voorbereiden op de installatie.',
	'EXT_NOT_WRITABLE'					=> 'De ext/ map is niet schrijfbaar. Dit is vereist om “Upload extensie” goed te laten functioneren. Verander de permissies en probeer het opnieuw.',
	...
	'EXT_UPLOAD_BACK'					=> '« Terug naar Upload Extensies',

	'ACP_UPLOAD_EXT_DIR'				=> 'Pad naar zip bestand van extensie',
	'ACP_UPLOAD_EXT_DIR_EXPLAIN'		=> 'Pad onder je phpBB installatie, b.v. <samp>ext</samp>.<br />Je kan dit veranderen om zip bestanden ergens anders op te slaan (bijvoorbeeld, als je gebruikers deze bestanden wil laten downloaden, kan je het veranderen naar <em>downloads</em>, als je downloaden wil verbieden, kan je het pad veranderen naar één dat een hoger http-niveau heeft (of je kan een map maken met een geschikt .htaccess bestand)).',

	'ACP_UPLOAD_EXT_UPDATED'			=> 'De geïnstalleerde extensie is geüpdatet.',
	'ACP_UPLOAD_EXT_UPDATED_EXPLAIN'	=> 'Je hebt een zip bestand geüpload voor een extensie die al geïnstalleerd is. Deze extensie <strong>is automatisch uitgeschakeld</strong> om het updateproces veiliger te maken. <strong>Controleer</strong> nu of de geüploade bestanden juist zijn en <strong>schakel de extensie in</strong> als het gebruikt wordt op het forum.',
));
